...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({UniqueKeyAlreadyRegisteredException.class})
    public ResponseEntity<ErrorResponse> handleUniqueKeyAlreadyRegisteredException(UniqueKeyAlreadyRegisteredException ex, WebRequest request) {
